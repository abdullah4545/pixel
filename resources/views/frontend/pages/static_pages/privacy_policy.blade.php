...
@if(isset($privacy->page_banner))
<section class="page-title bg-1" style="background: url({{ asset($privacy->page_banner) }}) no-repeat 50% 50%;
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="block text-center">
            <h1 class="text-capitalize mb-5 text-lg">Privacy Policy</h1>
          </div>
        </div>
      </div>
    </div>
