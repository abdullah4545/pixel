...
@php
    $faq = App\Models\Information::where('key', 'faq')->first();
@endphp

@if(isset($faq->page_banner))
<section class="page-title bg-1" style="background: url({{ asset($faq->page_banner) }}) no-repeat 50% 50%;
